...
int button_getButton(void) {
    ...
    if ((GPIO_PORTE_DATA_R & 0b1111) == 0b1111) {
        return 0;
    }
    else if ((GPIO_PORTE_DATA_R & 0b1000) == 0b0000) {
        return 4;
    }
    else if ((GPIO_PORTE_DATA_R & 0b0100) == 0b0000) {
        return 3;
    }
    else if ((GPIO_PORTE_DATA_R & 0b0010) == 0b0000) {
        return 2;
    }
    else if ((GPIO_PORTE_DATA_R & 0b0001) == 0b0000) {
        return 1;
    }
    return 0;
}
